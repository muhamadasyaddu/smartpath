...
@section('title', 'Tambah Pengaturan Prioritas')
...
<div class="mx-auto max-w-3xl">
    ...
    <form
        method="POST"
        action="{{ route('admin.pengaturan-prioritas.store') }}"
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('bobot_keparahan', '0.40') }}"
                    required
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('bobot_fasilitas', '0.25') }}"
                    required
                    class="mt-1.5 w-full rounded-xl border-slate-300"
                >
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <input
                    ...
                    min="10"
                    max="500"
                    value="{{ old('radius_deduplikasi_m', 50) }}"
                    required
                    class="mt-1.5 w-full rounded-xl border-slate-300"
                >

                <p class="mt-1 text-xs text-slate-500">
                    Parameter MVP SmartPath menggunakan 50 meter.
                </p>
            ...
            <div>
                ...
                <input
                    ...
                    min="100"
                    max="5000"
                    value="{{ old('radius_fasilitas_m', 500) }}"
                    required
                    class="mt-1.5 w-full rounded-xl border-slate-300"
                >
